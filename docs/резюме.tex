...
Backend developer with experience in highload systems and project management. Specialize in Python and Go with 3 years of production experience. I am in Moscow and ready to move.\\
\\
\noindent\textcolor[rgb]{0.1255,0.2902,0.7843}{\textbf{\Large{EXPERIENCE}}}\\
\begin{Large}
\textbf{Yandex}
\end{Large}
\hspace{282pt}May 2026 — Now\\
\textbf{Senior Python/Go Developer} — control-plane rewrite for load balancer infrastructure\\
• conceived and got management approval for a full control-plane rewrite\\
• recruited and lead a team of 3 engineers, designed the architecture, passed design review\\
• cut rollout time from 15–20 to 3–5 min and interventions from 8–10\% to under 1\%\\
\\
\begin{Large}
\textbf{Yandex}
\end{Large}
\hspace{272pt}February 2023 — Now\\
...
• built a load balancer allocator (heuristic + MILP) that rebalanced 1{,}000 services in 3 hours\\
• integrated mechanism for providing alerts to users that sends alerts within 30 seconds\\
\\
\begin{Large}
\textbf{Yandex}
\end{Large}
\hspace{257pt}July 2022 — October 2022\\
...
\textbf{Yandex}
\end{Large}
\hspace{247pt}July 2021 — November 2021\\
...
\textbf{Tinkoff}
\end{Large}
\hspace{257pt}October 2023 — April 2024\\
...
• assembled a team of 4 developers and led it, all deadlines were met\\
• collected the requirements from the customer, came up with several additional ideas\\
\\
\begin{Large}
\textbf{Huawei}
\end{Large}
\hspace{247pt}November 2021 — May 2022\\
...
\\
\begin{Large}
\href{https://www.canva.com/design/DAEaT9nPC7Y/y7_r2BzUEiUiFKW36oP-Pw/view?utm_content=DAEaT9nPC7Y&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink}{\textbf{Startup SmartLearning}}
\end{Large}
\hspace{127pt}November 2020 — March 2021\\
...
• assembled and managed a team of 4 developers\\
...
\begin{Large}
\textbf{\href{https://hse.ru/}{Higher School of Economics}}
\end{Large}
\hspace{92pt}September 2024 — July 2026\\
\href{https://www.hse.ru/ma/ipii/}{Master in AI Research \& Entrepreneurship}, GPA 8.8/10\\
• Graduated courses with excellence: Computational Complexity Theory, GPU Computing, Deep Learning, Bayesian Methods, Multi-Agent Systems\\
\\
\begin{Large}
\textbf{\href{https://hse.ru/}{Higher School of Economics}}
\end{Large}
\hspace{100pt}September 2020 — July 2024\\
...
\textbf{Python} (\href{https://github.com/igoose1/wikirace}{Django},\\
\href{https://github.com/NikPeg/Reinforcement-learning-for-resource-allocation-tasks-in-the-cloud}{numpy}, sklearn)\\
\textbf{Go} (goroutines,\\
Temporal, gRPC)\\
\textbf{Java} (\href{https://github.com/NikPeg/jigsaw_sockets_and_saving}{Sockets,}\\
...
\textbf{C\#}\\
(\href{https://gitlab.com/peganov.nik/messengerapi}{Requests})\\
\textbf{Kotlin} \href{https://gitlab.com/peganov.nik/smartlearning}{(Android)}\\
\textbf{\href{https://github.com/NikPeg/CoffeePult}{Databases}}\\
(\href{https://github.com/NikPeg/ExtraterrestrialBot}{SQLite}, \href{https://github.com/NikPeg/CoffeePult}{PostgreSQL}, Redis)\\
\\
...
\href{https://nikpeg.github.io/docs/DiplomaYandex2026.pdf}{\textbf{Software Architecture}: Advanced Program} (2026)\\
