...
\begin{tight}
  \item сравнил открытые LLM, играющие друг с другом в \plink{https://github.com/NikPeg/llm-graph-mafia-game}{мафию}, развёрнутые самостоятельно на A100
...
\entry{\plink{https://github.com/NikPeg/AI_Supervisor}{frAId} --- ИИ-супервизор для психотерапевтов}{2023}{Исследователь, разработчик}
\begin{tight}
  \item RAG-бот-супервизор: анализирует сессии и даёт обратную связь психологам (КПТ)
\end{tight}
...
\eduentry{\plink{https://www.hse.ru/ma/ipii/}{НИУ ВШЭ --- магистратура, <<Исследования и предпринимательство в ИИ>>}, средний балл 8,8/10}{2024--2026}
...
\sidehead{Рекомендации}
{\footnotesize
\plink{https://www.hse.ru/staff/kdegtiarev/}{Дегтярёв Константин Юрьевич}\,---\,доцент департамента программной инженерии ВШЭ\\[3pt]
Неверов Владимир Михайлович\,---\,руководитель группы управления трафиком, Яндекс
}
